#!/usr/bin/env python3
"""Train MinCatFlow using reimplementation.

Usage:
    uv run python src/scripts/train_reimpl.py configs/reimplementation/default.yaml
    uv run python src/scripts/train_reimpl.py configs/reimplementation/default.yaml --overwrite
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train MinCatFlow (reimplementation)")
